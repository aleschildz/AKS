...
Este grupo tiene una propiedad particular: hay un elemento (el $1$) tal que sus potencias generan todos los elementos del grupo. En otras palabras, todo elemento de $\mathbb{Z}_n$ es una potencia del elemento $1$. Por ejemplo, en $\mathbb{Z}_5$, tenemos que $2 = 1 \circ 1$, $3 = 1\circ1\circ1$, $4 = 1 \circ 1 \circ 1 \circ 1$ y $0 = 1 \circ 1 \circ 1 \circ 1 \circ 1$.
\hfill$\blacksquare$
\end{example}
...
\begin{definition}[Grupo cíclico finito]
