...
$X^2 = 2X \cdot q(X) + c$. Ahora veamos esta última igualdad en el cociente por el ideal generado por el polinomio constante $2$: obtenemos la ecuación $X^2 = c$. Según el isomorfismo descrito en la demostración de la proposición \ref{cociente_polinomio_constante}, tendríamos que $X^2 = c$ como polinomios en el anillo $\mathbb{Z}_2[X]$, lo que es absurdo.