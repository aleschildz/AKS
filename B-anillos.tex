...
\begin{tikzpicture}[scale=1.5] \label{dibujo_cociente}
...
Geométricamente, las clases laterales corresponden a rectas verticales (vea la ilustración \ref{dibujo_cociente})
\hfill$\blacksquare$
\end{example}
